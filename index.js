...
// * ---------------- Citar mensaje recibido ----------------
client.on("message", (message) => {
    if (message.body === "!ping") {
        //Este metodo responde citando directamente al mensage recibido
        message.reply("pong");
    }
});
// * ---------------- Contestar mensaje ----------------
client.on("message", (message) => {
    if (message.body === "!ping") {
        //sendMessage(destino, mensaje), envia un mensaje
        //from, obtiene la direccion del mensaje
